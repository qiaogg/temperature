          ...
          <el-card style="width:195vh;margin-top:30px">
            <el-tabs type="border-card">
                <el-tab-pane label="星期一">
                  <div>
                    <span style="margin-left:100px">温度变化折线图</span>
                    <span style="margin-left:700px">温度变化直方图</span>
                  </div>
                  <div id="a1" style="float:left;width:600px;height:400px;margin-top:30px"></div>
                  <div style="float:left;width: 1px;height: 500px; background: #000;"></div> 
                  <div id="a2" style="width:400px;height:500px;margin-left:600px;margin-left:200px"></div>
                </el-tab-pane>
                <el-tab-pane label="星期二">
                  <div class="b1"></div>
                  <div class="b2"></div>
                </el-tab-pane>
                <el-tab-pane label="星期三">角色管理</el-tab-pane>
                <el-tab-pane label="星期四">定时任务补偿</el-tab-pane>
                <el-tab-pane label="星期五">星期一</el-tab-pane>
                <el-tab-pane label="星期六">配置管理</el-tab-pane>
                <el-tab-pane label="星期日">角色管理</el-tab-pane>
            </el-tabs>
          </el-card>
        </el-main>
      </el-container>
