<template>
  <div >
    <el-container id="Main">
      ...
      <el-container>
        <el-main>
          <div style="height:400px;width:1490px;background:red;">
          ...
          <el-card>
            <div id="chart_example" style="width:1000px;height:700px">
            </div>
          </el-card > 
          <el-card style="width:195vh;margin-top:30px;height:600px">
